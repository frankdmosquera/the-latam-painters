...
const bmSets: CuratedPaletteSet[] = [
  ...
  bmTheme("north-creek-brown", "North Creek Brown", bmColor("North Creek Brown", "1001", "#65594A", "https://www.benjaminmoore.com/en-us/paint-colors/color/1001/north-creek-brown"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("fairview-taupe", "Fairview Taupe", bmColor("Fairview Taupe", "HC-85", "#7C7161", "https://www.benjaminmoore.com/en-us/paint-colors/color/hc-85/fairview-taupe"), bmTrim.whiteHeron, bmAccent.wenge),
  bmTheme("branchport-brown", "Branchport Brown", bmColor("Branchport Brown", "HC-72", "#60514A", "https://www.benjaminmoore.com/en-us/paint-colors/color/hc-72/branchport-brown"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("love-and-happiness", "Love & Happiness", bmColor("Love & Happiness", "1191", "#F2D9CC", "https://www.benjaminmoore.com/en-us/paint-colors/color/1191/love-happiness"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("conch-shell", "Conch Shell", bmColor("Conch Shell", "052", "#E6BDAC", "https://www.benjaminmoore.com/en-us/paint-colors/color/052/conch-shell"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("sailors-delight", "Sailor's Delight", bmColor("Sailor's Delight", "1296", "#F3BCBA", "https://www.benjaminmoore.com/en-us/paint-colors/color/1296/sailors-delight"), bmTrim.chantillyLace, bmAccent.wroughtIron),
  bmTheme("dream-whip", "Dream Whip", bmColor("Dream Whip", "2174-60", "#F4D7D1", "https://www.benjaminmoore.com/en-us/paint-colors/color/2174-60/dream-whip"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("first-light", "First Light", bmColor("First Light", "2102-70", "#EFE2DE", "https://www.benjaminmoore.com/en-us/paint-colors/color/2102-70/first-light"), bmTrim.chantillyLace, bmAccent.wroughtIron),
  bmTheme("cinnamon-slate", "Cinnamon Slate", bmColor("Cinnamon Slate", "2113-40", "#897475", "https://www.benjaminmoore.com/en-us/paint-colors/color/2113-40/cinnamon-slate"), bmTrim.chantillyLace, bmAccent.wenge),
  bmTheme("new-age", "New Age", bmColor("New Age", "1444", "#D6CED1", "https://www.benjaminmoore.com/en-us/paint-colors/color/1444/new-age"), bmTrim.chantillyLace, bmAccent.wenge),
  bmTheme("winter-gray", "Winter Gray", bmColor("Winter Gray", "2117-60", "#D0CDD6", "https://www.benjaminmoore.com/en-us/paint-colors/color/2117-60/winter-gray"), bmTrim.chantillyLace, bmAccent.wenge),
  bmTheme("lily-lavender", "Lily Lavender", bmColor("Lily Lavender", "2071-60", "#DBCEE8", "https://www.benjaminmoore.com/en-us/paint-colors/color/2071-60/lily-lavender"), bmTrim.chantillyLace, bmAccent.wenge),
  ...
  bmTheme("shadow", "Shadow", bmColor("Shadow", "2117-30", "#514A58", "https://www.benjaminmoore.com/en-us/paint-colors/color/2117-30/shadow"), bmTrim.chantillyLace, bmAccent.wenge),
  bmTheme("golden-straw", "Golden Straw", bmColor("Golden Straw", "2152-50", "#EFDDB5", "https://www.benjaminmoore.com/en-us/paint-colors/color/2152-50/golden-straw"), bmTrim.simplyWhite, bmAccent.hunterGreen),
  bmTheme("concord-ivory", "Concord Ivory", bmColor("Concord Ivory", "HC-12", "#E7CD8D", "https://www.benjaminmoore.com/en-us/paint-colors/color/hc-12/concord-ivory"), bmTrim.simplyWhite, bmAccent.hunterGreen),
  bmTheme("marblehead-gold", "Marblehead Gold", bmColor("Marblehead Gold", "HC-11", "#E1C478", "https://www.benjaminmoore.com/en-us/paint-colors/color/hc-11/marblehead-gold"), bmTrim.simplyWhite, bmAccent.hunterGreen),
  bmTheme("chestertown-buff", "Chestertown Buff", bmColor("Chestertown Buff", "HC-9", "#DDBF86", "https://www.benjaminmoore.com/en-us/paint-colors/color/hc-9/chestertown-buff"), bmTrim.simplyWhite, bmAccent.hunterGreen),
  bmTheme("wild-flower", "Wild Flower", bmColor("Wild Flower", "2090-40", "#BF7065", "https://www.benjaminmoore.com/en-us/paint-colors/color/2090-40/wild-flower"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("dinner-party", "Dinner Party", bmColor("Dinner Party", "AF-300", "#763637", "https://www.benjaminmoore.com/en-us/paint-colors/color/af-300/dinner-party"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("classic-burgundy", "Classic Burgundy", bmColor("Classic Burgundy", "HC-182", "#69181A", "https://www.benjaminmoore.com/en-us/paint-colors/color/hc-182/classic-burgundy"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("heritage-red", "Heritage Red", bmColor("Heritage Red", "HC-181", "#990A14", "https://www.benjaminmoore.com/en-us/paint-colors/color/hc-181/heritage-red"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("peach-parfait", "Peach Parfait", bmColor("Peach Parfait", "2175-70", "#F9E7DA", "https://www.benjaminmoore.com/en-us/paint-colors/color/2175-70/peach-parfait"), bmTrim.whiteHeron, bmAccent.wenge),
  bmTheme("venetian-portico", "Venetian Portico", bmColor("Venetian Portico", "AF-185", "#C4A996", "https://www.benjaminmoore.com/en-us/paint-colors/color/af-185/venetian-portico"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("italianate", "Italianate", bmColor("Italianate", "AF-215", "#CB9976", "https://www.benjaminmoore.com/en-us/paint-colors/color/af-215/italianate"), bmTrim.whiteHeron, bmAccent.wenge),
  bmTheme("topaz", "Topaz", bmColor("Topaz", "070", "#C06A46", "https://www.benjaminmoore.com/en-us/paint-colors/color/070/topaz"), bmTrim.whiteHeron, bmAccent.wenge),
  bmTheme("electric-orange", "Electric Orange", bmColor("Electric Orange", "2015-10", "#F0701A", "https://www.benjaminmoore.com/en-us/paint-colors/color/2015-10/electric-orange"), bmTrim.whiteHeron, bmAccent.wenge),
  bmTheme("black-satin", "Black Satin", bmColor("Black Satin", "2131-10", "#313435", "https://www.benjaminmoore.com/en-us/paint-colors/color/2131-10/black-satin"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("midnight", "Midnight", bmColor("Midnight", "2131-20", "#373D3F", "https://www.benjaminmoore.com/en-us/paint-colors/color/2131-20/midnight"), bmTrim.whiteDove, bmAccent.terraMauve),
  bmTheme("french-beret", "French Beret", bmColor("French Beret", "1610", "#4C4F52", "https://www.benjaminmoore.com/en-us/paint-colors/color/1610/french-beret"), bmTrim.whiteDove, bmAccent.terraMauve),
  bmTheme("silver-satin", "Silver Satin", bmColor("Silver Satin", "OC-26", "#E3E2DA", "https://www.benjaminmoore.com/en-us/paint-colors/color/oc-26/silver-satin"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("soot", "Soot", bmColor("Soot", "2129-20", "#373C41", "https://www.benjaminmoore.com/en-us/paint-colors/color/2129-20/soot"), bmTrim.whiteDove, bmAccent.haleNavy),
  bmTheme("charcoal-slate", "Charcoal Slate", bmColor("Charcoal Slate", "HC-178", "#646769", "https://www.benjaminmoore.com/en-us/paint-colors/color/hc-178/charcoal-slate"), bmTrim.whiteDove, bmAccent.witchingHour),
  bmTheme("etiquette", "Etiquette", bmColor("Etiquette", "AF-50", "#E5E0D5", "https://www.benjaminmoore.com/en-us/paint-colors/color/af-50/etiquette"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("brilliant-white", "Brilliant White", bmColor("Brilliant White", "OC-150", "#EBEEE9", "https://www.benjaminmoore.com/en-us/paint-colors/color/oc-150/brilliant-white"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("newburg-green", "Newburg Green", bmColor("Newburg Green", "HC-158", "#445962", "https://www.benjaminmoore.com/en-us/paint-colors/color/hc-158/newburg-green"), bmTrim.whiteDove, bmAccent.haleNavy),
  bmTheme("van-deusen-blue", "Van Deusen Blue", bmColor("Van Deusen Blue", "HC-156", "#485B6E", "https://www.benjaminmoore.com/en-us/paint-colors/color/hc-156/van-deusen-blue"), bmTrim.whiteDove, bmAccent.gentlemansGray),
  bmTheme("decorators-white", "Decorator's White", bmColor("Decorator's White", "CC-20", "#EBEDEA", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-20/decorators-white"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  // --- Expansion: Benjamin Moore Designer Classics collection (231-color line most specified by interior designers) ---
  bmTheme("asphalt", "Asphalt", bmColor("Asphalt", "CC-548", "#7F7D77", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-548/asphalt"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("buckhorn", "Buckhorn", bmColor("Buckhorn", "CC-510", "#84735E", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-510/buckhorn"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("gray-mist", "Gray Mist", bmColor("Gray Mist", "CC-80", "#E3DFD2", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-80/gray-mist"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("natural-linen", "Natural Linen", bmColor("Natural Linen", "CC-90", "#D7CDB7", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-90/natural-linen"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("rocky-road", "Rocky Road", bmColor("Rocky Road", "CC-470", "#B7AA9A", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-470/rocky-road"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("stanley-park", "Stanley Park", bmColor("Stanley Park", "CC-602", "#A39F87", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-602/stanley-park"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  ...
  bmTheme("blue-nose", "Blue Nose", bmColor("Blue Nose", "CC-800", "#63879F", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-800/blue-nose"), bmTrim.whiteDove, bmAccent.haleNavy),
  bmTheme("five-dollar-bill", "Five Dollar Bill", bmColor("Five Dollar Bill", "CC-812", "#81A5C0", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-812/five-dollar-bill"), bmTrim.whiteDove, bmAccent.haleNavy),
  bmTheme("kensington-blue", "Kensington Blue", bmColor("Kensington Blue", "CC-780", "#4B5A71", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-780/kensington-blue"), bmTrim.whiteDove, bmAccent.haleNavy),
  ...
  bmTheme("summer-mist", "Summer Mist", bmColor("Summer Mist", "CC-906", "#9DB2D0", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-906/summer-mist"), bmTrim.whiteDove, bmAccent.haleNavy),
  bmTheme("backwoods", "Backwoods", bmColor("Backwoods", "CC-630", "#586251", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-630/backwoods"), bmTrim.chantillyLace, bmAccent.hunterGreen),
  bmTheme("grasslands", "Grasslands", bmColor("Grasslands", "CC-590", "#AFB288", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-590/grasslands"), bmTrim.chantillyLace, bmAccent.hunterGreen),
  bmTheme("jack-pine", "Jack Pine", bmColor("Jack Pine", "CC-660", "#5A7169", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-660/jack-pine"), bmTrim.chantillyLace, bmAccent.hunterGreen),
  bmTheme("night-owl", "Night Owl", bmColor("Night Owl", "CC-662", "#59523C", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-662/night-owl"), bmTrim.chantillyLace, bmAccent.hunterGreen),
  bmTheme("sesame", "Sesame", bmColor("Sesame", "CC-638", "#DBD6A7", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-638/sesame"), bmTrim.chantillyLace, bmAccent.hunterGreen),
  bmTheme("almond-bisque", "Almond Bisque", bmColor("Almond Bisque", "CC-280", "#E7DBBB", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-280/almond-bisque"), bmTrim.whiteHeron, bmAccent.wenge),
  bmTheme("cable-knit", "Cable Knit", bmColor("Cable Knit", "CC-306", "#E2D2B3", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-306/cable-knit"), bmTrim.whiteHeron, bmAccent.wenge),
  bmTheme("hiking-trail", "Hiking Trail", bmColor("Hiking Trail", "CC-514", "#9D8774", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-514/hiking-trail"), bmTrim.whiteHeron, bmAccent.wenge),
  bmTheme("muslin", "Muslin", bmColor("Muslin", "CC-110", "#E1D6C1", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-110/muslin"), bmTrim.whiteHeron, bmAccent.wenge),
  bmTheme("bonaparte", "Bonaparte", bmColor("Bonaparte", "CC-64", "#9F3E3E", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-64/bonaparte"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("louisiana-hot-sauce", "Louisiana Hot Sauce", bmColor("Louisiana Hot Sauce", "CC-124", "#8E3F30", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-124/louisiana-hot-sauce"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("rapture", "Rapture", bmColor("Rapture", "CC-66", "#9C2E3B", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-66/rapture"), bmTrim.simplyWhite, bmAccent.wroughtIron),
  bmTheme("bed-and-breakfast", "Bed and Breakfast", bmColor("Bed and Breakfast", "CC-184", "#C18872", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-184/bed-and-breakfast"), bmTrim.whiteHeron, bmAccent.wenge),
  bmTheme("french-toast", "French Toast", bmColor("French Toast", "CC-244", "#EACFA0", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-244/french-toast"), bmTrim.whiteHeron, bmAccent.wenge),
  bmTheme("rusty-nail", "Rusty Nail", bmColor("Rusty Nail", "CC-390", "#9C6040", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-390/rusty-nail"), bmTrim.whiteHeron, bmAccent.wenge),
  bmTheme("basic-blue", "Basic Blue", bmColor("Basic Blue", "CC-968", "#3F457D", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-968/basic-blue"), bmTrim.chantillyLace, bmAccent.wenge),
  bmTheme("french-violet", "French Violet", bmColor("French Violet", "CC-960", "#696D86", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-960/french-violet"), bmTrim.chantillyLace, bmAccent.wenge),
  bmTheme("nightfall-sky", "Nightfall Sky", bmColor("Nightfall Sky", "CC-38", "#6F6578", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-38/nightfall-sky"), bmTrim.chantillyLace, bmAccent.wenge),
  bmTheme("boulevard", "Boulevard", bmColor("Boulevard", "CC-394", "#C3B8AE", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-394/boulevard"), bmTrim.whiteDove, bmAccent.witchingHour),
  bmTheme("inukshuk", "Inukshuk", bmColor("Inukshuk", "CC-460", "#CDC4B5", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-460/inukshuk"), bmTrim.whiteDove, bmAccent.witchingHour),
  bmTheme("barley", "Barley", bmColor("Barley", "CC-180", "#EDD7A4", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-180/barley"), bmTrim.simplyWhite, bmAccent.hunterGreen),
  bmTheme("golden-honey", "Golden Honey", bmColor("Golden Honey", "CC-214", "#FAE1A0", "https://www.benjaminmoore.com/en-us/paint-colors/color/cc-214/golden-honey"), bmTrim.simplyWhite, bmAccent.hunterGreen),
